...
Protanki Tool is a versatile desktop application designed to help you automate repetitive tasks on ProTanki. It provides a simple interface to configure and trigger actions like mouse clicks at specific coordinates, all manageable through global hotkeys.
...
1.  **Launch the application:** Start ``ProtankiTool.exe``.
...
1.  Clone the repository:
    ...
    ```
2.  Open `ProtankiTool.sln` in Visual Studio.
